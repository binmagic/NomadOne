...
prisma/schema.prisma - User + AppSettings.allowRegister + AppSettings.modelTimeoutMs + Project.userId + Project.kind(DETAIL_PAGE|LISTING_SET|PRODUCT_SWAP) + ProviderConfig.userId + StudioConversation.userId + PromptTemplate.userId
