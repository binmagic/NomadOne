...
prisma/schema.prisma - User + AppSettings.allowRegister + AppSettings.modelTimeoutMs + Project.userId + Project.kind(DETAIL_PAGE|LISTING_SET) + ProviderConfig.userId + StudioConversation.userId
