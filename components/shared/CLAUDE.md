...
成员清单
image-dropzone.tsx: 图片拾取器。点击与拖放收敛为 File[]，不编码不上传；挂载期间拦截窗口级文件 drop，避免浏览器打开本地文件。被 quick-start / batch-create / listing-set-form / product-swap-form / project-creator 消费。
