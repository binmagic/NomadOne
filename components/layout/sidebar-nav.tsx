 ...
 * [OUTPUT]: 对外提供 SidebarNav，按路径高亮；含对话生图 /studio、提示词 /prompts、违禁词 /forbidden-words、商品套图 /listing-set、实拍换品 /product-swap；OWNER 才看到用户管理与设置
...
import { ArrowLeftRight, Ban, BookOpenText, FolderKanban, GalleryVerticalEnd, History, Images, LayoutGrid, SlidersHorizontal, Sparkles, Users, Wand2 } from "lucide-react";
...
const navItems = [
  ...
  { href: "/forbidden-words", label: "违禁词", icon: Ban },
